...
def create_itemgroup_record(make, model, description, organization_id, moniker=None):
    itemgroup = ItemGroup(
        make=make, model=model, description=description, moniker=moniker, organization_id=organization_id
    )
